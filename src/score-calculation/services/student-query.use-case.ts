        ...
        const applicableSubjects = student.subjectScores
            ...
            .map(s => {
                ...
                return {
                    ...
                    achievementRatio: s.achievementRatio ?? null,
                    rank: s.rank ?? null,
                    sameRank: s.sameRank ?? null,
                    studentCount: s.studentCount ?? null,
                    originalScore: s.originalScore ?? null,
                    avgScore: s.avgScore ?? null,
                    standardDeviation: s.standardDeviation ?? null,
